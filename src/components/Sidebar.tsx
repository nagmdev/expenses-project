    ...
    <>
      ...
      `}>
        <div className="flex-1 overflow-y-auto py-5 px-3 space-y-4">
          ...
          <div className="bg-slate-50/80 p-3 rounded-2xl border border-slate-200/60 flex items-center justify-between gap-3">
